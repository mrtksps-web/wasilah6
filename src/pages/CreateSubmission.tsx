    ...
    try {
      ...
      if (submissionType === 'project') {
        ...
        insertData = {
          ...
          headName: projectData.headName,
          headDesignation: projectData.headDesignation,
          headImage: projectData.headImage,
        ...
        insertData = {
          ...
          headDesignation: eventData.headDesignation,
          headImage: eventData.headImage,
          submittedBy: currentUser.uid,
          submitterName: userData.displayName || 'Unknown User',
          submitterEmail: userData.email || '',
          status: finalStatus,
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="luxury-card bg-cream-white p-8">
          <form className="space-y-8">
            ...
            {/* Head/Organizer Information */}
            <div>
              <h3 className="text-2xl font-luxury-heading text-black mb-6">{submissionType === 'project' ? 'Project Head' : 'Event Organizer'} Information</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block font-luxury-medium text-black mb-2">Name</label>
                  <input
                    type="text"
                    value={submissionType === 'project' ? projectData.headName : eventData.headName}
                    onChange={(e) => handleInputChange('headName', e.target.value)}
                    className="w-full px-4 py-3 border-2 border-vibrant-orange/30 rounded-luxury focus:outline-none focus:ring-2 focus:ring-vibrant-orange focus:border-vibrant-orange font-luxury-body"
                    placeholder="Enter head/organizer name"
                  />
                </div>
                <div>
                  ...
                  <input
                    type="text"
                    value={submissionType === 'project' ? projectData.headDesignation : eventData.headDesignation}
                    onChange={(e) => handleInputChange('headDesignation', e.target.value)}
                    className="w-full px-4 py-3 border-2 border-vibrant-orange/30 rounded-luxury focus:outline-none focus:ring-2 focus:ring-vibrant-orange focus:border-vibrant-orange font-luxury-body"
                    placeholder="e.g., Project Manager, Event Coordinator"
                  />
                </div>
                <div className="md:col-span-2">
                  <ImageUploadField
                    label="Profile Photo"
                    value={submissionType === 'project' ? projectData.headImage : eventData.headImage}
                    onChange={(url) => handleInputChange('headImage', url)}
